/*
Question 2-
Let f(x) = x - 0.8 - 0.2 Sin(x). Use Newton’s method to find the zero in [−1,1]. Compare the results with those obtained using Secant method and bisection method. In all the cases  compute the root up to an accuracy of 10^−6. */
